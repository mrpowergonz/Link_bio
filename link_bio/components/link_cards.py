...
def link_cards() -> rx.Component:
    return rx.vstack(
        rx.card(
            ...
            footer="Sloth machine created with Python",
            font_size= Size.DEFAULT.value, 
...
def alternative(title: str, footer: str, image: str, imagez: str, url: str) -> rx.Component:
    return rx.link(
        create_card_structure(title, footer, image, imagez, url),
        href=url,
        passHref=True,
        scroll="True",
        fontWeight="bold",
...
def alternative_card(title: str, footer: str, image: str, imagez: str, url: str) -> rx.Component:
    return rx.link(
        create_card_structure(title, footer, image, imagez, url),
        href=url,
        passHref=True,
